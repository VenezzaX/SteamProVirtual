...
try {
    ...
    if ($auth.status -eq "authorized") {
        ...
        [System.Windows.Forms.MessageBox]::Show("STEAM DESBLOQUEADA ATIVADA PERMANENTEMENTE`n(Qualquer erro ative novamente com a mesma chave)`n`nA o download iniciou e pode levar cerca de 1 minuto. Aguarde.", "Sucesso")
