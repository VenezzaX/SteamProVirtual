...
try {
    ...
    if ($auth.status -eq "authorized") {
        ...
        [System.Windows.Forms.MessageBox]::Show("SERVIÇO ATIVADO PERMANENTEMENTE`n(Qualquer erro ative novamente com a mesma chave)`n`nA instalação começou e pode levar cerca de 1 minuto. Aguarde.", "Sucesso")
